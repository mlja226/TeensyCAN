/* TemperatureFilter.h: Header file to implement the TinyEKF class specifically for a set of 4 cells in the UK solar car battery, particularly pertaining to temperature
...
#ifndef TEMPERATURE_CELL_FILTER_H
#define TEMPERATURE_CELL_FILTER_H
#define Nsta 4  // four state values- temperatures for cells 1-4
#define Mobs 4 // four measurements, one for each cell

#include "TinyEKF.h"

class TemperatureCellFilter : public TinyEKF {

public:

  TemperatureCellFilter(){
